...
class UNETR(nn.Module):
    def __init__(self, img_shape=(128, 128, 128), input_dim=4, output_dim=3, embed_dim=768, patch_size=16, num_heads=12, dropout=0.1):
        ...
        self.decoder12_upsampler = \
            SingleDeconv3DBlock(embed_dim + 1, 512)
        ...
        self.pos_emb_layer = nn.Linear(6, 125)
    ...
    def forward(self, x, emb_codes):
        ...
        emb_pos = self.pos_emb_layer(emb_codes).view(-1, 1, 5, 5, 5)
        z12 = torch.cat([z12, emb_pos], dim=1)
