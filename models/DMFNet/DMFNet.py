...
import torch
from .synch_batchnorm import SynchronizedBatchNorm3d
...
if __name__ == '__main__':
    ...
    x = torch.rand((4,2,128,128,128),device=device) # [bsize,channels,Height,Width,Depth]
    model = DMFNet(c=2, groups=16, norm='sync_bn', num_classes=1)
    model.cuda(device)
    y = model(x)
    print(y.shape)
