...
class padUNet3D(nn.Module):
    def __init__(self, num_classes):
        ...
        if torch.cuda.device_count() != 2:
            raise Exception("can't see 2 GPU available")

        self.encoder = Encoder().cuda(0)
        self.decoder = Decoder(num_classes).cuda(1)
    ...
    def forward(self, x):
        ...
        return self.decoder(embedding, feat_0.cuda(1), feat_1.cuda(1), feat_2.cuda(1))
