...
class SchedulerFactory():
    def __init__(self, name, optimizer, LR=1e-4, steps_per_epoch=204, epochs=100, **kwargs):
    ...
    def get(self):
        if self.name == 'MultiStepLR':
            ...
            scheduler = torch.optim.lr_scheduler.OneCycleLR(self.optimizer, **self.kwargs)   
